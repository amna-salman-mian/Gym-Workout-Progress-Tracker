  ...
  List notArr = [
    {
      "day": "2",
      "Detail":
          " You exercised for 40 minutes a day and five days a week at a certain time. You practice on a regular schedule. Changing the schedule will result in diminished results, resulting in fatigue."
    },
    {
      "day": "14",
      "Detail":
              ...
              child: Stack(
                children: [
                  CalendarCarousel(
                    ...
                    showHeader: false,
                    customDayBuilder: (
                      // to build function to make custom day containers
                      bool isSelectable,
                      int index,
                      bool isSelectedDay,
                      bool isToday,
