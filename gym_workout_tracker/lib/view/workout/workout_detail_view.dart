  ...
  List responseArr = [
    {
      ...
      "message":
          "Jumping really gets your heart rate up, doesn't it? Great way to boost cardio!"
    },
    {
      "name": "Louise Parker",
      "time": "11 days ago",
      ...
      "message":
          "I love the energy in the gym when everyone's running and jumping together."
    },
    {
      "name": "Matt Roberts",
      "time": "12 days ago",
      "image": "assets/img/u2.png",
      "message":
          "Jumping exercises really engage those core muscles, it's like a total-body workout."
    },
    {
      "name": "Scott Laidler",
      "time": "13 days ago",
      "image": "assets/img/u1.png",
      "message":
          "There's something therapeutic about the rhythmic sound of footsteps on the treadmill."
    }
  ];
